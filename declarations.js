...
var INVALID_ELSE = 'La ligne contient un "' + ELSE + '" qui ne se rapport à aucun "' + IF + '"';
var EMPTY_LINE = "Ligne vide";
var LINE_STR = "Ligne";
var INFO_CAPS = "Attention, les ordres ne doivent pas contenir majuscules."
